...
<!--[if gte IE 9]>
  ...
  <script src="style/js/html5shiv.min.js" type="text/javascript"></script>
  <script src="style/js/respond.min.js" type="text/javascript"></script>
  <script src="style/js/selectivizr-min.js" type="text/javascript"></script>
<![endif]-->
<!--[if lt IE 9]>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="style/images/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="style/images/baoman_01.gif" alt="深思熟虑" />
...
<script src="style/js/admin-scripts.js"></script>
<script src="style/js/ueditor.config.js"></script> 
<script src="style/js/ueditor.all.min.js"> </script> 
<script src="style/js/zh-cn.js"></script>  
