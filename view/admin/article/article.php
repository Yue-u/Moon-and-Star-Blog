            ...
            <form action="/Article/checkAll" method="post" >
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            ...
                            <td>{$article.time}</td>
                            <td><a href="update-article.ht  ml">修改</a> <a rel="6">删除</a></td>
                        </tr>
                        {/volist}
                        </tbody>
                    </table>
                ...
                <footer class="message_footer">
                    <nav>
                        ...
                        <ul class="pagination pagenav pager">
                            {volist name="article" id="articleo"}
                            <li class="active">{$articleo.nickname}</li>
                            {/volist}
                        </ul>
                    </nav>
                </footer>
...
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body"> <img src="/static/images/baoman_01.gif" alt="深思熟虑" />
